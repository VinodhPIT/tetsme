        ...
        item.image ? (
          <div key={index} className="d-flex flex-column  custom-container ">
            <div className={itemStyle}>
              <h4 className="bg-dark text-light fs-3 px-2 py-1">
                {item.button1}
              </h4>
              <h4 className="bg-dark text-light fs-3 px-2 py-1">
                {item.button2}
          ...
          <div className="d-flex flex-column w-50  custom-margin" key={index}>
            <h1 className="fw-bold">Download the app for more!</h1>
            <p className="fs-5">
              We hand pick every tattoo artist to ensure your tattoo experience
              is handled with care,quality and inclusivity
            </p>
            <a href="">
              <img className="download-link-image" src="./Group 82237.png" />
            </a>
          </div>
        )
      )}
