                  ...
                  <SearchField isPage={"all"} />
                    ...
                    <div className="trend_list_wrap">
                      ...
                      <ul className="trend_list">
                        ...
                        <li className="list_inline_item">
                          <Link href={`/search?term=${""}&category=${"artist"}`} onClick={()=>serverLoad(true)}>
                  ...
                  <div class="text_box_content justify_content_start">
                    <div class="text_box_content_inner">
                      ...
                      <a href="#" class="btn btn_secondary btn_xxl btn_sm_m">
                        Find artists
                        <img src="./alt-arrow-right-white.svg" alt="" class="ml-8 mt-2"/>
                      </a>
                    </div>
                  </div>
                ...
                <div class="img_text_box_inner">
                  ...
                  <div class="img_box_wrap block_bg_gradient_1 justify_content_right img-btm-7pc">                   
                    <div class="box_text_img_over color_aero_blue_lite txt-right-align">
                      ...
                      <span class="small letter_spacing_02">Are you a </span>Tattooartist?
                      </h2>
                    </div>
                    <img src="./are-you-tattooartist-istockphoto-1367127235-1024x1024 8.png" alt="" />
                  </div>
                </div>
              </div>
